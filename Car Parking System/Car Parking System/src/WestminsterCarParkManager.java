...
public class WestminsterCarParkManager implements CarParkManager {
	...
	public static void displayLogin() {
		...
		if (userName.equals("harsh") && password.equals("harsh123")) {// if
																		// userName
																		// and
																		// password equals
			// then display menu
	...
	public void addVehicle() {
		...
		case "car":
			...
			System.out.print("Enter car shade :");
			String shade = input.next();
			vehicleParkingSlots[checkFreeSpace] = new Car(id, brand, entryTime, noOfDoors, color, shade);
			break;
		case "van":
